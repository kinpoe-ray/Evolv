-- Migration: enhance_skill_graph_and_badge_system_fixed
-- Created at: 1762008193
...
ADD COLUMN IF NOT EXISTS level_required INTEGER CHECK (level_required >= 1 AND level_required <= 5) DEFAULT 1,
ADD COLUMN IF NOT EXISTS market_demand INTEGER CHECK (market_demand >= 0 AND market_demand <= 100) DEFAULT 0;
